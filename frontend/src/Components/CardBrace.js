...
const CardBrace = () => {
  return (
        <div className="cardBrace">
            ...
            <Card text={'DAC & CO. LTD have designed and built a triple A rated House in North Country Dublin - one of the only three triple A rated houses constructed in Ireland.'} img={aplus} />
        </div>
  )
}
