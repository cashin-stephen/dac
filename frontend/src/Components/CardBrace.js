...
const CardBrace = () => {
    ...
    return (
        ...
        <div className="cardBrace">
            <Card text={"We offer full-scale renovations and new build construction. Our personalized service, attention to detail, and experience set us apart."} img={house} linkText={"See Our Services"} />
